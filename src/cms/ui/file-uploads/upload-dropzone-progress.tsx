...
import { Progress } from "@/cms/ui/progress";
      ...
      <AnimatePresence mode="popLayout">
        {progresses.length === 0 ? (
          <motion.div
            ...
            exit="hidden"
            className={cn(
              "relative rounded-lg border bg-background shadow-xs border-dashed transition-colors",
              {
                  ...
                  {typeof description === "string" ? (
                    ...
                    <>
                      ...
                      {description?.maxFileSize &&
                        `${
                          description.maxFiles !== 1 ? "Each u" : "U"
                        }p to ${description.maxFileSize}.`}{" "}
                  ...
                  <div className="grid grow gap-1">
                    <div className="flex items-center gap-0.5">
                      <p className="max-w-40 truncate text-sm font-medium">
                        {/* This correctly shows the original filename (e.g., 'cake.jpg') */}
                        {progress.name}
                      </p>
